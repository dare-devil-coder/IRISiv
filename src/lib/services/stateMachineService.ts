...
const VALID_TRANSITIONS: Record<ProjectStatus, ProjectStatus[]> = {
  ...
  AI_ANALYZING: ['NGO_REVIEW', 'DRAFT'],
  NGO_REVIEW: ['SUBMITTED', 'DRAFT'],
  ...
  FULFILLMENT_SUBMITTED: ['MILESTONE_40_PAID', 'MANUAL_REVIEW', 'DISPUTED'],
  MILESTONE_40_PAID: ['NGO_CONFIRMATION_PENDING'],
