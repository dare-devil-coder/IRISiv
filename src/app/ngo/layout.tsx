...
export default function NGOPortalLayout({ children }: { children: React.ReactNode }) {
  ...
  const navItems = [
    ...
    { href: '/ngo/requirements', label: 'Requirements' },
    { href: '/ngo/projects', label: 'Projects' },
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      {/* Dedicated NGO Portal Header */}
      <header className="sticky top-0 z-40 w-full border-b border-teal-200/80 bg-white/95 backdrop-blur-md shadow-xs">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          {/* Brand & Portal Badge */}
          <div className="flex items-center gap-3">
            <Link href="/ngo/dashboard" className="flex items-center gap-2">
              <div className="h-8 w-8 rounded-lg bg-teal-600 border border-teal-700 flex items-center justify-center text-white shadow-xs">
            ...
            <div className="hidden sm:flex items-center gap-1.5 text-xs text-slate-600">
              <span className="font-bold text-slate-800">Shiksha Foundation</span>
          ...
          <div className="flex items-center gap-3">
            <Link
              ...
              className="hidden sm:inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-bold text-xs shadow-xs transition"
            >
            ...
            <div className="flex items-center gap-2">
              <div className="flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-slate-100 text-slate-700 text-xs font-medium">
                ...
                <span className="hidden md:inline font-semibold">Ananya S.</span>
              </div>
